...
COMMANDS
     ...
     "readme_from"
         ...
         A third parameter can be used to determine the format of the "README"
         file.
         ...
         If you use the "all_from" command, "readme_from" will default to that
         value.
...
perl v5.42.3                      2017-02-17 Module::Install::ReadmeFromPod(3)
