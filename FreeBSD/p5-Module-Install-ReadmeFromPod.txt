Module::Install::ReadmeFromPod(3)          User Contributed Perl Documentation
...
COMMANDS
       ...
       "readme_from"
           Does nothing on the user-side. On the author-side it will generate
           a "README" file.
           ...
           pdf Produce a PDF "README.pdf" file with App::pod2pdf if this
               module is installed.
           ...
           Finally, you can pass additional arguments to the POD formatter
           that handles the requested format.
...
perl v5.40.2                      2017-02-17 Module::Install::ReadmeFromPod(3)
