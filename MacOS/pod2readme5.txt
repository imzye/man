...
OPTIONS
   ...
   "--output"
       Specifies the name of the output file. If omitted, it will use the second
       command line argument, or default to the "--target" plus the
       ...
       will be added, e.g. for "markdown", the default output file is README.md.
   ...
   "--format"
       ...
       Other supposed formats are "github", "html", "latex", "man", "markdown",
       "pod", "rtf", and "xhtml". You can also use "gfm" instead of "github".
       Similary you can use "md" for "markdown".
...
perl v5.30.2                       2018-10-31                      POD2README(1)
